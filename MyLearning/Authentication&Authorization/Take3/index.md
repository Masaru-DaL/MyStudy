...
Web開発における認可を考える時も、**相手が誰であるかという考えをを切り離して考える事**が重要です。
...
多くの人が認証と認可を同一のように認識してしまう例の1つに免許証を例に「運転免許証」が挙げられます。免許証には、個人情報と写真などにより「本人であること」を証明し、その上で「その人に対して運転をする権限を与えている」からです。
