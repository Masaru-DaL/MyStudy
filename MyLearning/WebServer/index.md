...
3. インターネット上で提供するコンピュータ機能を利用する仕組みを**クラウドコンピューティング**と言い、その中のサービスの1つでサーバを提供している。

### 4-1. 共有サーバと専有サーバの比較

|               | 共有サーバ                | 専有サーバ               |
| ------------- | -------------------- | ------------------- |
| **特徴**        | 1台のサーバを複数のユーザで利用する   | 1台のサーバを1人で専有して利用する  |
| **メリット**      | <li>コストが安い</li><li>専門知識が不要</li>       | <li>リソースを専有できる</li><li>カスタマイズ可能</li> |
| **デメリット**     | <li>自由度が低い</li><li>他のユーザの影響を受けやすい</li> | <li>コストがかかる</li><li>専門知識が必要</li>     |
| **向いている人・企業** | 個人利用・小規模企業           | 上級者・大企業向け                    |

### 4-2. 仮想専有サーバ(VPS)

### 4-3. クラウドコンピューティングサービス
