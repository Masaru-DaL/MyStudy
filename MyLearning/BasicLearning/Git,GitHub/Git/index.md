...
1. 2つブランチを作る test1, test2
2. test1で変更A, test2で変更B
3. それぞれコミットした状態にする
4. test2に変更Aを取り入れる
`git cherry-pick 1fe47f5086d23079fbfa93a857a37ed0053686b6`
5. test2に変更Aが取り込まれた。

### 10-6. Patch（つぎはぎ）

変更内容をまとめたファイルを作成する機能。
例えば、メインブランチで作業中に間違いに気づいたが、既にメインブランチから別のブランチに分岐させて作業を初めてしまっていた場合などに有用。
