...
AWSで提供しているデータベースサービスにARDS(**A**mazon **R**elational **D**atabase **S**ervice)があります。ARDSのバックアップの設定は自身で設定することになります。AWSのバックアップは、バックアップの回数、復元するバックアップデータの量などによって料金が変わってきます。
