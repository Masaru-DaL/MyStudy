...
クラウドの導入は手軽に行える反面、提供されている膨大なサービスの特徴やサービスモデルなどを把握し、適切に利用する事が求められます。

可用性を高めるために行わなければいけない事さえ分かっていれば、後はそれが実現できるサービスを選ぶだけです。自身が携わるサービスの可用性を高めるためにも可用性に対する正しい知識を身につける必要があります。
