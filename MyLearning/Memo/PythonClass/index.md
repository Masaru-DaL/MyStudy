...
- [Python クラス入門](#python-クラス入門-1)
  ...
  - [クラスを使用するメリットとクラスの使い所](#クラスを使用するメリットとクラスの使い所)
  - [クラスの定義方法](#クラスの定義方法)
...
見ての通り、クラスを使用すると関数を実装した時よりも長くなっています。これはクラスの利用に適した使い方をしていないからです。クラスを正しく使うにはクラスを使った利点を正しく理解することが必要です。

## クラスを使用するメリットとクラスの使い所

上で行って分かったように、**クラスは必ず使わなければいけない！**というわけではありません。まずは、クラスをどういった時に使えばいいのか？を押さえておきましょう。
