...
関数でいいじゃんと思うかもしれませんが、クラスを使用するともっと大きな枠で処理を共通化する事ができます。例えば人間クラスというものに人間として共通する部分を定義し、その人間クラスを引き継いで更に男性クラス、女性クラスを作成する事が可能です。男性クラスは男性として共通する処理、女性クラスは女性として共通する処理を定義します。そして、実体としての男性、女性を作成する、というような事ができます。これが**継承**です。
