...
Pythonのクラス入門編として、「クラスとは何か」に焦点を当て、実際にコードに触れながらクラスに対する理解を深めていきましょう。

## クラスとは

クラスを利用すると何が良いのか？と思うかもしれません。クラスは、必ずしも使わなければいけない！というわけではありませんが、クラスを利用すると以下のようなメリットがあります。

- 似たようなコードを繰り返す書く必要がなくなる
- コードを再利用しやすい
- 機能を拡張しやすい

つまり、クラスを使用するということは、リファクタリングを行うという意味合いでもあります。
...
、コードまだクラスの入り口部分しか解説していませんので、クラスで行えることや
